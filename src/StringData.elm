module StringData exposing (withPredicate)
...
textListWithPredicate predicate =
    T.manyNonEmpty (Parser.Advanced.oneOf [ withPredicate predicate, escapedChar ])
...
withPredicate : (Char -> Bool) -> Parser StringData
